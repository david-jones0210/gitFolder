...
ModulesAreaLaws2.filter_list_for_timestamp(time_stamp, f_lines)

for conn in range(0, max_conn+1):
  patches_in_area = ModulesAreaLaws2.get_patches_in_area(conn, start_patch, patchcount)
  if patches_in_area == []:
  ...
  ModulesAreaLaws2.count_del_species(patches_in_area, time_stamp, f_lines, species_counter)
