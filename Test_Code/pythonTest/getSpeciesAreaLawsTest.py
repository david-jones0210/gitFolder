...
import os
import sys
import ModulesAreaLawsTest2



f_read = open('mm_species.out', 'r')
...
ModulesAreaLawsTest2.filter_list_for_timestamp(time_stamp, f_lines)

for conn in range(0, max_conn+1):
  patches_in_area = ModulesAreaLawsTest2.get_patches_in_area(conn, start_patch, patchcount)
  if patches_in_area == []:
  ...
  ModulesAreaLawsTest2.count_del_species(patches_in_area, time_stamp, f_lines, species_counter)
